...
#[Route(path: '/gestion/template', name: 'gestion_template_')]
class TemplateController extends GestionControllerLib
{
    ...
    {
        return $this->gestionService->setDomain(Template::class);
    }
}
