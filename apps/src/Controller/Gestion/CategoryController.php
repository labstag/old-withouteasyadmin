...
#[Route(path: '/gestion/category', name: 'gestion_category_')]
class CategoryController extends GestionControllerLib
{
    ...
    {
        return $this->gestionService->setDomain(Category::class);
    }
}
