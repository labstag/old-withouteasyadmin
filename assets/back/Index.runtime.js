...
window.customElements.define('link-btngestion', LinkBtnAdmin)
window.customElements.define('link-btngestiondelete', LinkBtnAdminDelete)
window.customElements.define('link-btngestiondeleties', LinkBtnAdminDeleties)
window.customElements.define('link-btngestiondestroy', LinkBtnAdminDestroy)
window.customElements.define('link-btngestionempties', LinkBtnAdminEmpties)
window.customElements.define('link-btngestionempty', LinkBtnAdminEmpty)
window.customElements.define('link-btngestionemptyall', LinkBtnAdminEmptyAll)
window.customElements.define('link-btngestionmove', LinkBtnAdminMove)
window.customElements.define('link-btngestionnewblock', LinkBtnAdminNewBlock)
window.customElements.define('link-btngestionrestore', LinkBtnAdminRestore)
window.customElements.define('link-btngestionrestories', LinkBtnAdminRestories)
